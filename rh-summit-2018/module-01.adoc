...
The Prometheus data source, and the Kafka dashboard, can be set up in Grafana by following these steps.
...
In the URL field, use `http://prometheus.l1099-kafka.svc.cluster.local:9090` as the URL to the Prometheus server.
